    ...
    <div class="py-5 bg-white">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h4>New Arrivals
                        <a href="{{route('new.arrivals')}}" class="btn btn-primary btn-sm float-end">See More</a>
                    </h4>
                    <div class="underline mb-4"></div>
                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <h4>Featured Products
                        <a href="{{route('featured.products')}}" class="btn btn-primary btn-sm float-end">See More</a>
                    </h4>
                    <div class="underline mb-4"></div>
                </div>
                @if ($featuredProducts)
