                                    ...
                                    <div class="d-md-flex align-items-start">
                                        ...
                                        <div class="tab-content col-md-9" id="v-pills-tabContent">
                                            <div class="tab-pane active show fade" id="cashOnDeliveryTab" role="tabpanel" aria-labelledby="cashOnDeliveryTab-tab" tabindex="0">
                                                ...
                                                <hr/>
                                                <button type="button" wire:loading.attr="disabled" wire:click = "cashOnDelivery" class="btn btn-primary">
...
<script src="https://www.paypal.com/sdk/js?client-id=Ad5PqxeWnJ1k03dK7xXbFWkVcjAgf5li4txjVitRWw0DOKmMR7qHReUKSbKJKCW7sNv7Tc2hZmHPBQAN&currency=USD"></script>
    ...
    onClick: function()  {
      ...
      onApprove: (data, actions) => {
        ...
        if(transaction.status ="COMPLETED") {
            LiveWire.emit('transationEmit',transaction.id)
        }
        });
      }
